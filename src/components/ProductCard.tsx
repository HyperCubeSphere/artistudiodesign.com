    ...
    <article className="product-card group flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-baseline justify-between gap-4 mt-1 pt-3 border-t hairline-soft">
          <span className="tabular-nums text-sm" style={{ color: 'var(--color-muted)' }}>
          ...
          <Link
            ...
            className="text-xs uppercase tracking-[0.18em] text-[var(--color-accent)] hover:text-[var(--color-accent-hover)] transition-colors"
          >
